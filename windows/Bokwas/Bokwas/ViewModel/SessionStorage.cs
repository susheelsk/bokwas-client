...
namespace Bokwas.ViewModel
{
    public class SessionStorage
    {
        ...
        private const string AccessTokenFacebookIDKeyName = "fb_id";
        ...
        public static FacebookSession Load()
        {
            ...
            string fbID = LoadEncryptedSettingValue(AccessTokenFacebookIDKeyName);

            // return true only if both values retrieved and token not stale
            if (!string.IsNullOrWhiteSpace(accessTokenValue) && !string.IsNullOrWhiteSpace(fbID) && expiryValue > DateTime.UtcNow)
            {
        ...
        public static void Save(FacebookSession session)
        {
            ...
            SaveEncryptedSettingValue(AccessTokenFacebookIDKeyName, session.FacebookId);
        ...
        public static void Remove()
        {
            ...
            RemoveEncryptedSettingValue(AccessTokenFacebookIDKeyName);
